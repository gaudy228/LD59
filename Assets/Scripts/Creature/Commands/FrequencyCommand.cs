...
public class FrequencyCommand : ICommand
{
    ...
    public FrequencyCommand(int frequency, List<Creature> creatures, GameObject owner, float moveDistance, float duration)
    {
    ...
    public void Execute()
    {
        if (_creatures != null)
        {
            ...
            {
                creature.ChangeFrequency(_frequency);
            }
        }
    }
}
